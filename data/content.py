...
SITE = {
    ...
    "description": "The best Kill The Shadow guides: full walkthrough, choices and endings, all cases, the investigation system, achievements, system requirements and FAQs.",
    "language": "en",
    "gaId": "",
    "gscVerification": "",
    "adsenseId": "",
...
P("how-to-play",
  ...
  "New to Kill The Shadow? Learn the investigation loop, crime-scene reconstruction, time rewind, the Shadow corruption meter and how choices shape the story.",
...
P("endings",
  ...
  "Everything confirmed about Kill The Shadow's multiple endings: how many there are, and how the Shadow corruption meter and your choices branch the story.",
...
P("investigation",
  ...
  "How investigation works in Kill The Shadow: crime-scene reconstruction, logic chains of deduction, time rewind and the evidence needed to solve each case.",
...
P("tips-and-tricks",
  ...
  "Practical Kill The Shadow tips: use reconstruction early, read medical documents, track contradictions, manage the Shadow meter and experiment with rewind.",
